 ...
 * relocated validator at skills/humanizer-pro/scripts/lib/en-validate.js.
 * Upstream: conorbronsdon/avoid-ai-writing@7a2c7d11 detector/validate.test.js
 */

const assert = require('node:assert/strict');
const { validate, formatResult, maskCode } = require('../skills/humanizer-pro/scripts/lib/en-validate.js');
