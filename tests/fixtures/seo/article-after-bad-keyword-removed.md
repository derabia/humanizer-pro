...
# Quick answers for high-traffic APIs

Our approach moves the responses users request most often out to servers
near them, which cuts response time by a wide margin for endpoints that get
