...
Notes on places where the improvement-plan instructions (`docs/COMPETITIVE-ANALYSIS.md`
§6, IMP-11, 15, 16, 18, 19, 21, 22, 25, 26) did not match the actual shape of
...
Grepped both source trees for `2023`, `2024`, `2025`, `GPT`, `Claude`, and
