...
// Modified by humanizer-pro (2026-09-17): relocated to
// skills/humanizer-pro/scripts/lib/en-validate.js; updated the default
// detector's internal require path from './patterns.js' to
// './en-detector/index.js' to match the new layout (no other logic changes).
// Upstream: conorbronsdon/avoid-ai-writing@7a2c7d11 detector/validate.js
  ...
  function validate(original, rewritten, options = {}) {
    ...
    if (!options.skipResidual) {
      ...
      if (!detector && typeof require === 'function') {
        try {
          detector = require('./en-detector/index.js');
        } catch (_) {
          detector = null;
        }
      }
